                ...
                {frames.length > 0 && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                    {frames.map((frame) => {
                      ...
                      return (
                        <div key={`frame-${frame.id}`} className="group bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden hover:shadow-lg transition-all duration-300">
                          ...
                          <div className="aspect-square bg-slate-50 relative p-8 flex items-center justify-center overflow-visible">
                             ...
                             {!currentPhoto && (
                                <div className="absolute inset-0 flex items-center justify-center bg-slate-50/50 backdrop-blur-[2px]">
                                  <span className="text-slate-400 text-xs font-bold uppercase tracking-widest">Loading Preview...</span>
                                </div>
                             )}
                          </div>

                          {/* Info Section - Matching Admin spacing and border-top */}
                          <div className="p-6 border-t border-slate-50">
                            <h3 className="text-lg font-bold text-slate-900 mb-4 line-clamp-1">{frame.name}</h3>
                            <Link 
